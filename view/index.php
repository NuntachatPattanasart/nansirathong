        ...
        <div class="col-md-3 mb-3">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <a href="product_one.php" class="btn btn-primary w-50 d-flex justify-content-center">คลิก</a>
            </div>
          </div>
        </div>
        <!-- 2 -->
        <div class="col-md-3 mb-3">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <a href="product_two.php" class="btn btn-primary w-50 d-flex justify-content-center">คลิก</a>
            </div>
          </div>
        </div>
        <!-- 3 -->
        <div class="col-md-3 mb-3">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <a href="product_three.php" class="btn btn-primary w-50 d-flex justify-content-center">คลิก</a>
            </div>
          </div>
        </div>
        <!-- 4 -->
        <div class="col-md-3 mb-3">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <a href="product_four.php" class="btn btn-primary w-50 d-flex justify-content-center">คลิก</a>
            </div>
          </div>
        </div>
      </div>
